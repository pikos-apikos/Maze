...
{
    public class DFSRecursiveGraphSolverShould
    {
        IServiceProvider servicesProvider;
        ILogger<MazeTextLoader> logger;

        DFSRecursiveGraphSolver sut;

        public DFSRecursiveGraphSolverShould()
        {
            ...
            var slogger = servicesProvider.GetRequiredService<ILoggerFactory>().CreateLogger<DFSRecursiveGraphSolver>();

            // System Under Test  
            sut = new DFSRecursiveGraphSolver(slogger);
