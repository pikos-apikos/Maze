...
{
    public class DijkstraGraphSolverShould
    {
        IServiceProvider servicesProvider;
        ILogger<MazeTextLoader> logger;
        DijkstraGraphSolver sut;

        public DijkstraGraphSolverShould()
        {
            ...
            var slogger = servicesProvider.GetRequiredService<ILoggerFactory>().CreateLogger<DijkstraGraphSolver>();

            // System Under Test  
            sut = new DijkstraGraphSolver(slogger);

        }


        /// <summary>
        /// Using the default configuration.  Solver should return one solution
        /// </summary>
        [Fact]
